      ...
      <div className="w-full h-full my-auto flex lg:flex-col items-center justify-between lg:justify-center gap-x-20 lg:gap-x-0 gap-y-20">
        ...
        >
          ...
          <textarea
            ...
            value={form.message}
            onChange={handleChange}
            className="max-h-[250px] min-h-[100px] border border-yellow-500 rounded-md bg-zinc-100 px-4 py-2 text-sm tracking-wider text-gray-700 outline-none dark:bg-zinc-300"
